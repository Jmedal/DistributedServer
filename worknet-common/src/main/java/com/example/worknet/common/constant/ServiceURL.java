...
/**
 * @Author: YunJieJiang
 * @Date: Created in 19:57 2019/6/28 0028
 */
public interface ServiceURL {

    String CompanyContestApplyService = Const.SERVER_URL_COMPANY + "/companyContestApplyService";

    String CompanyContestService = Const.SERVER_URL_COMPANY + "/companyContestService";
