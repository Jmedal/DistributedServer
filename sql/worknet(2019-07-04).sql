...
CREATE TABLE `sys_company_cv`  (
  ...
  `sex` int(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '性别',
  ...
  `identity` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '身份证号',
  `qualification` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学历',
  `specialty` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '专业',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '面试邀约表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `sys_learner_info` VALUES (1, 3, 'T49Jml', '姜云杰', NULL, 20, '996', '本科一年级', '123', '123', '123', '吃喝玩乐', NULL, 0);
INSERT INTO `sys_learner_info` VALUES (2, 4, 'IrhErX', NULL, NULL, NULL, NULL, '本科一年级', NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_learner_info` VALUES (3, 5, 'MjpYks', NULL, NULL, NULL, NULL, '本科一年级', NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_learner_info` VALUES (4, 6, 'LOaTvM', NULL, '男', 0, NULL, '本科一年级', NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_learner_info` VALUES (5, 7, 'XYMAWB', NULL, '男', 0, NULL, '本科一年级', NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_learner_info` VALUES (6, 8, 'r98AKq', NULL, '男', 0, NULL, '本科一年级', NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_learner_info` VALUES (7, 9, 'jXtWNU', 'AAD13456', '男', 13456, 'AAD13456', '本科一年级', 'AAD13456', 'AAD13456', 'AAD13456', 'AAD13456', NULL, 0);
INSERT INTO `sys_learner_info` VALUES (8, 1, 'lst', 'lst', '男', 0, 'lst', '本科一年级', NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_learner_info` VALUES (9, 10, 'FOycYJ', NULL, '男', 0, NULL, '本科一年级', NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_learner_info` VALUES (10, 11, 'vv1c18', NULL, '男', 0, NULL, '本科一年级', NULL, NULL, NULL, NULL, NULL, 0);
